...
Download the latest ready-to-install Android package directly from GitHub:

[**Download Latest Android APK (v1.0.0)**](https://github.com/CodingfulAlt/Cairn/releases/download/v1.0.0/Cairn-v1.0.0.apk)

1. Download `Cairn-v1.0.0.apk` onto your Android device.
...
On Android tablets and foldables in landscape mode, Cairn adapts into a multi-column view with a navigation rail:
